...
if (isset($_POST['submit'])) {
  ...
  if (empty($nameErr) && empty($emailErr) && empty($bodyErr)) {
    // add to database
    $sql = "INSERT INTO blog (name, email, body) VALUES ('$name', '$email', '$body')";
...
?>
    ...
    <img src="img/Blog_Sharing.png" class="w-25 mb-3" alt="">
    <h2>Blog Sharing</h2>
    <?php echo isset($name) ? $name : ''; ?>
    <p class="lead text-center">Leave Blog for Sharing</p>
    ...
    <form method="POST" action="<?php echo htmlspecialchars(
      ...
      <div class="mb-3">
        ...
        <div id="validationServerBlog" class="invalid-blog">
      ...
      <div class="mb-3">
        ...
        <textarea class="form-control <?php echo !$bodyErr ?:
          'is-invalid'; ?>" id="body" name="body" placeholder="Enter your blog"><?php echo $body; ?></textarea>
      </div>
      <div class="mb-3">
